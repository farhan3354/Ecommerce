                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="qty-box">
                                    <div class="input-group">
                                        <input type="number" onchange="updateQuantity(this)" name="quantity" data-rowid="{{$item->rowId}}" class="form-control input-number" value="{{$item->qty}}">
                                    </div>
                                </div>
                            </td>
                            <td>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-4 col-sm-6 ">
                        <div class="checkout-button">
                            <a href="{{ route('home') }}" class="btn btn-solid-default btn fw-bold">
                            ...
                            <div class="cart-box-details">
                                <div class="total-details">
                                    ...
                                    <div class="bottom-details">
                                        <a href="{{ route('home') }}">Process Checkout</a>
                                    </div>
                                </div>
                            </div>
                        </div>
