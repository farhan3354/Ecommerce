            ...
            <div class="col-12">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{$wproduct->name}}</li>
                    </ol>
                </nav>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-2">
                                    <div class="details-image-vertical black-slide rounded">
                                        <div>
                                            <img src="{{asset('assets/images/fashion/product/front')}}/{{$wproduct->image}}" class="img-fluid blur-up lazyload" alt="{{$wproduct->name}}">
                                        </div>
                                        @if($wproduct->images) 
                                        @php 
                                            $images = explode(',',$wproduct->images);
                                        @endphp  
                                ...
                                <div class="col-lg-10">
                                    <div class="details-image-1 ratio_asos">
                                        <div>
                                            <img src="{{asset('assets/images/fashion/product/front')}}/{{$wproduct->image}}" class="img-fluid w-100 image_zoom_cls-0 blur-up lazyload" alt="{{$wproduct->name}}">
                                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="cloth-details-size">
                                ...
                                <h3 class="price-detail">
                                    @if($wproduct->sale_price)
                                        ${{$wproduct->sale_price}}
                                    <del>${{$wproduct->regular_price}}</del><span>
                                        {{ round((($wproduct->regular_price - $wproduct->sale_price)/$wproduct->regular_price)*100) }}
                                        % off</span>
                                    @else
                                        {{$wproduct->regular_price}}
                                    @endif
                                ...
                                <div class="mt-2 mt-md-3 border-product">
                                    <h6 class="product-title hurry-title d-block">
                                        @if($wproduct->stock_status=='instock')
                                            InStock
                                        @else
                                            Out Of Stock
                                        @endif
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="product-wrapper product-style-2 slide-4 p-0 light-arrow bottom-space">
                    @foreach ($rwproducts as $rwproduct)
                                            
                    <div>
                        <div class="product-box">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="{{route('shop.product.details',['slug'=>$rwproduct->slug])}}">
                                        <img src="{{asset('assets/images/fashion/product/front')}}/{{$rwproduct->image}}"
                                            class="bg-img blur-up lazyload" alt="">
                                    </a>
                                </div>
                                <div class="back">
                                    <a href="{{route('shop.product.details',['slug'=>$rwproduct->slug])}}">
                                        <img src="{{asset('assets/images/fashion/product/back')}}/{{$rwproduct->image}}"
                                            class="bg-img blur-up lazyload" alt="">
                                    </a>
                                </div>
                                <div class="cart-wrap">
                            ...
                            <div class="product-details">
                                ...
                                <div class="main-price">
                                    <a href="{{route('shop.product.details',['slug'=>$rwproduct->slug])}}" class="font-default">
                                        <h5>{{$rwproduct->name}}</h5>
                                    </a>
