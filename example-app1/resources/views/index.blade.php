        ...
        <div class="row gy-4">
            <div class="col-lg-4 col-md-6">
                <div class="collection-banner p-bottom p-center text-center">
                    <a href="{{ route('cart.index') }}" class="banner-img">
                    ...
                    <a href="{{ route('cart.index') }}" class="contain-banner">
                ...
                <div class="product-box">
                    ...
                    <div class="product-style-3 product-style-chair">
                        <div class="product-title d-block mb-0">
                            ...
                            <a href="{{ route('cart.index') }}" class="font-default">
        ...
        <div class="row gy-3">
            ...
            <div class="col-xxl-10 col-lg-9">
                <div class="category-wrapper category-slider1 white-arrow category-arrow">
                    ...
                    <div>
                        <a href="{{ route('cart.store') }}" class="category-wrap category-padding">
                    ...
                    <div>
                        <a href="{{ route('wishlist.list') }}" class="category-wrap category-padding">
                    ...
                    <div>
                        <a href="{{ route('wishlist.store') }}" class="category-wrap category-padding">
                    ...
                    <div>
                        <a href="{{ route('contact.form') }}" class="category-wrap category-padding">
                            <img src="assets/images/fashion/category/3.jpg" class="bg-img blur-up lazyload"
                                alt="category image">
                            <div class="category-content category-text-1">
                                <h3 class="theme-color">Jeans</h3>
