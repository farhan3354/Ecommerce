                                ...
                                <div class="main-navbar">
                                    <div id="mainnav">
                                        ...
                                        <ul class="nav-menu">
                                            ...
                                            <li><a href="{{ route('app.form') }}" class="nav-link menu-title">Contact Us</a>
                                            </li>
                                            <li><a href="{{ route('app.blog') }}" class="nav-link menu-title">Blog</a></li>
                                        <li>        <div class="sticky-top"><a  href="https://web.whatsapp.com/">Whatsapp</a></div>
                                        </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-contact">
                            ...
                            <ul class="contact-lists" style="clear:both;">
                                <li>
                                    <span><b>phone:</b> <span class="font-light"><p><a href='tel:+923141637204'>03141637204</a></p></span></span>
                                </li>
                                <li>
                                    <span><b>Address:</b><span class="font-light"><p ><a href='https://maps.app.goo.gl/v8py9s3PL7vWYATb8'>Ali Town Lahore</a></p>                                    </span></span>
                                </li>
                                <li>
                                    <span><b>Email:</b><span class="font-light"><a href='mailto:farhanbashir3354@gmail.com'>farhanbashir3354@gmail.com</a></span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="footer-links">
                            ...
                            <div class="footer-content">
                                <ul>
                                    ...
                                    <li>
                                        <a href="{{ route('cart.index') }}" class="font-dark">Shop</a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="{{ route('app.form') }}" class="font-dark">Contact</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="footer-links">
                            ...
                            <div class="footer-content">
                                <ul>
                                    ...
                                    <li>
                                        <a href="{{ route('app.paymen') }}" class="font-dark">Your Account</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('wishlist.list') }}" class="font-dark">Track Orders</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('wishlist.list') }}" class="font-dark">Your Wishlist</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('cart.index') }}" class="font-dark">Shopping FAQs</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="sub-footer">
            <div class="container">
                <div class="row gy-3">
                    ...
                    <div class="col-md-6">
                        <p class="mb-0 font-dark"> Farhan Media.</p>
                        <button style="border-radius: 40px;height:40px;background-color:#e87316;"><a href="https://web.whatsapp.com/" style="color: white">Whats'app</a></button>
                    </div>
                </div>
            </div>
        </div>
